...
class MLP_for(nn.Module):
	def __init__(self, num_pts):
		...
		self.conv6 = nn.Conv1d(2512, 512, 1) # 1024 + 64 + 1280 = 2512  /  3280
...
class MLP_rev(nn.Module):
	def __init__(self, num_pts):
		...
		self.conv6_2 = nn.Conv1d(1024, 80, 1)
		self.conv6_3 = nn.Conv1d(1024, 64, 1)
		...
		self.bn6_2 = nn.BatchNorm1d(80)
		self.bn6_3 = nn.BatchNorm1d(64)
		self.num_pts = num_pts
		self.max_pool = nn.MaxPool1d(num_pts)
