...
def main(args):
    ...
    checkpoint_fp = 'ckpts_basis156_0817/SynergyNet_checkpoint_epoch_100.pth.tar' 
    args.arch = 'mobilenet_v2'
    args.devices_id = [0]
    checkpoint = torch.load(checkpoint_fp, map_location=lambda storage, loc: storage)['state_dict']
    inference_output = 'inference_output_0817' 
    ...
    for img_fp in files:
        ...
        # landmarks
        draw_landmarks(img_ori_copy, pts_res, wfp='{}/landmarks/{}.jpg'.format(inference_output, name))
